...
const MmHeader = props => {
  const showHeader = /discover|video/.test(props.location.pathname)
  const open = function mmHeaderOpenDrawer() {
    props.onOpen(true)
  }
  const openSearch = function mmHeaderOpenDrawer() {
    props.history.push(`${router_prefix}/search`)
  }
  return (
    showHeader && (
      <header className="mm-header">
        ...
        <div className="mm-header-title">
          ...
          <NavLink className="mm-header-item discover" to={router_prefix+'/discover'} />
