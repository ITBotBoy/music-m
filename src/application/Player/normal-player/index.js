...
import { prefixStyle, formatPlayTime, getName,getPicUrl } from "@/api/utils";
import {
    ...
    >
      <NormalPlayerContainer ref={normalPlayerRef}>
        <div className="background">
          <img
            src={getPicUrl(song)+ "?param=300x300"}
            width="100%"
            height="100%"
            alt="歌曲图片"
          />
        ...
        <Top className="top">
          ...
          <div className="text">
            ...
            <h1 className="subtitle">{getName(song)}</h1>
          </div>
        </Top>
            ...
            >
              ...
              <div className="cd">
                <img
                  ...
                  src={getPicUrl(song) + "?param=400x400"}
                  alt=""
                />
              </div>
